...
const navigation = [
  { name: 'Ruin Betting', href: '#', current: true },
  { name: 'Auctions', href: '/auctions', current: false },
  { name: 'My Bids', href: '/my-bids', current: false },
  { name: 'My Auctions', href: '/my-auctions', current: false },
  {/*{ name: 'Profile', href: '/profile', current: false },
  { name: 'Login', href: '/login', current: false }, // Login link
  { name: 'Sign Up', href: '/signup', current: false }, // Sign Up link*/}
];
      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <Link to ="/login">
              <button class="rounded-full bg-gray-700 border-1 border-solid border-white">Login Now</button>
            </Link>
          </div>
        </div>
      </div>
